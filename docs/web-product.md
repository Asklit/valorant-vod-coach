...
| `/reports` | Coaching plan, report history, corrections, and evaluation runs |
...
- Browser authentication uses an `HttpOnly`, `Secure` in hosted mode, `SameSite=Strict` session cookie.
